    ...
    <div className="bg-white min-h-screen ">
      ...
      <div className="mx-auto px-6 mt-12">
        {wishlist.length > 0 ? (
          ...
          <div className="text-center py-16 bg-gray-50 rounded-md border border-gray-100">
            <h2 className="text-xl font-bold text-gray-900 mb-2">Your wishlist is empty</h2>
            <p className="text-gray-500 mb-6">Browse our collection and add items you love!</p>
            <button onClick={() => navigate("/")} className="inline-block bg-brand-hover text-white text-[13px] font-bold py-3.5 px-8 rounded-sm uppercase tracking-wider hover:bg-gray-800 transition-colors">
              Continue Shopping
            </button>
          </div>
        )}
